...
<head>
	...
	<title>admin subject register</title>
...
<body>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="form-group" data-aos="fade-up" data-aos-delay="200">
          <form method="POST" action="<?php echo base_url('index.php/Control/add_branch_subject');?>">
            <div class="mx-auto" id="branch_div" align="center" style="margin-top: 50px;">
              <select class="form-control" name="select_branch" id="branch" required>
            ...
            <div class="form-group" style="margin-top: 20px;">  
              <input type="text" class="form-control font-italic" name="subject_name" placeholder="Subject name" required>
            </div>
