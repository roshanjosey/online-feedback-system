...
<head>
	...
	<title>admin subject registered</title>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li style="margin-top: 5px;">
            <form method="POST" action="<?php echo base_url('index.php/Control/course_search');?>">
              <div class="md-form">
                <input class="form-control-sm" type="text" name="search" placeholder="Search" aria-label="Search">
                <button type="submit" class="btn btn-warning btn-sm" style="float: right;"><i class="fa fa-search"></i></button> 
              </div>  
            </form>
          </li>
        </ul>
      ...
      <div class="table-responsive">
            ...
            <table class="table table-borderless">
              ...
              <?php
                ...
                {
              ?>
                <form method="POST" action="<?php echo base_url('index.php/Control/branch_subject_delete/'.$value->subject_id);?>">
                  <tbody>
                    <tr>
