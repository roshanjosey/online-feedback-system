...
<head>
	...
	<title>faculty logged page</title>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?php echo base_url('index.php/Control/subject_registration/'.$value->faculty_id);?>">Subject Registration</a></li>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row">
            ...
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/faculty_my_profile/'.$value->faculty_id);?>"><i class="fas fa-user-circle fa-5x"></i></a><br><br>
              <h4>MY PROFILE</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/faculty_edit_profile/'.$value->faculty_id);?>"><i class="fas fa-edit fa-5x"></i></a><br><br>
              <h4>EDIT PROFILE</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/view_feedback');?>"><i class="far fa-comment-alt fa-5x"></i></a><br><br>
              <h4>VIEW FEEDBACK</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/faculty_logout/'.$value->faculty_id);?>"><i class="fas fa-sign-out-alt fa-5x"></i></a><br><br>
              <h4>LOGOUT</h4>
            </div> 
  	  ...
  	  <!-- ======= Footer ======= -->
	  <footer id="footer" style="margin-top: 10px;" data-aos="fade-up" data-aos-delay="400">
