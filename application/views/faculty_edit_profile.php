    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        ...
        <?php
          ...
          {
        ?>
          <li class="active"><a href="<?php echo base_url('index.php/Control/faculty_logged_page/'.$value->faculty_id);?>">Home</a></li>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row">
  		<div class="col-xs-12 col-sm-12 col-md-12" data-aos="fade-up" data-aos-delay="100">
            ...
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('index.php/Control/faculty_profile_update/'.$value->faculty_id);?>">
              <div class="form-row container-fluid">
                <div class="form_group col-sm-6">
                  <div class="row">
                    <input type="image" name="faculty_image" src="<?php echo base_url('image/'.$value->faculty_image);?>" required height="100px" width="150px" style="border: 1px solid black;">                  
                  </div>
                </div>
                <div class="form-group col-sm-6">
                  <div class="row">
                    <label>Name</label>
                    <input type="text" class="form-control" name="faculty_name" required value="<?php echo $value->faculty_name;?>">
                  </div>
                </div>                
              </div><br>
              <div class="form-group">
                <label>Gender</label><br>
                <input type="radio" name="faculty_gender" value="male" required <?php 
                if($value->faculty_gender=="male")
                  {
                    echo "checked";
                  }
                ?>>male
                <input type="radio" name="faculty_gender" value="female" required style="margin-left: 5px;" <?php
                if($value->faculty_gender=="female")
                {
                  echo "checked";
                }
                ?>>female
              ...
              <div class="form-group">
                <label>Address</label>
                <input type="text" class="form-control" name="faculty_address" required value="<?php echo $value->faculty_address;?>">
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label>DOB</label>
                  <input type="date" class="form-control" name="faculty_dob" required value="<?php echo $value->faculty_dob;?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Phone Number</label>
                  <input type="text" class="form-control" name="faculty_phone_number" pattern="[789][0-9]{9}" required value="<?php echo $value->faculty_phone_number;?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-5">
                  <label for="inputCity">City</label>
                  <input type="text" class="form-control" name="faculty_city" required value="<?php echo $value->faculty_city;?>">
                </div>
                <div class="form-group col-md-5">
                  <label>State</label>
                  <input type="text" class="form-control" name="faculty_state" required value="<?php echo $value->faculty_state;?>">
                </div>
                <div class="form-group col-md-2">
                  <label>Zip</label>
                  <input type="number" class="form-control" name="faculty_zip" required value="<?php echo $value->faculty_zip;?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label>Email</label>
                  <input type="email" class="form-control" name="faculty_email" required value="<?php echo $value->faculty_email;?>">
                </div>
                <div class="form-group col-md-6">
                  <label for="inputPassword4">Password</label>
                  <input type="password" class="form-control" name="faculty_password" pattern=".{6,}" title="Six or more characters" required value="<?php echo $value->faculty_password;?>">
                </div>
              </div>
              <div align="center" style="margin-top: 10px;">
                  <button type="submit" class="btn btn-primary" onclick="alertfunction()">update</button>
              </div>
            </form>
	    ...
	    <div class="footer-top" style="height: 300px;">
	      <div class="container">
	        <div class="row">
	          ...
	          <div class="col-xs-4 col-sm-4 col-md-12 footer-info">
	            <h3>Holy Christ</h3>
	            <p>
