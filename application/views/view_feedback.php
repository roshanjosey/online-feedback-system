      ...
      <div class="table-responsive">
            ...
            <table class="table table-borderless">
              ...
              <?php
                ...
                {
              ?>
                <form method="POST" action="<?php echo base_url('index.php/Control/feedback_delete/'.$value->feedback_id);?>">
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $value->student_branch;?></td>
                      <td><?php echo $value->student_subject;?></td>
