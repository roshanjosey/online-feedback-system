  ...
  <header id="header">
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          <li class="active"><a href="<?php echo base_url('index.php/Control/admin_logged_page');?>">Home</a></li>
      ...
      <div class="table-responsive">
            ...
            <table class="table table-borderless">
              ...
              <?php
                ...
                {
              ?>
                <form method="POST" action="<?php echo base_url('index.php/Control/faculty_delete/'.$value->faculty_id);?>">
                  <tbody>
                    <tr>
                      <th scope="row"><?php echo $i;?></th>
                      <td><?php echo $value->faculty_name;?></td>
                      <td><?php echo $value->faculty_gender;?></td>
                      <td><?php echo $value->faculty_address;?></td>
                      <td><?php echo $value->faculty_dob;?></td>
                      <td><?php echo $value->faculty_phone_number;?></td>
                      <td><?php echo $value->faculty_city;?></td>
                      <td><?php echo $value->faculty_state;?></td>
                      <td><?php echo $value->faculty_zip;?></td>
                      <td><?php echo $value->faculty_email;?></td>
                      <td><input type="image" name="faculty_image" src="<?php echo base_url('image/'.$value->faculty_image);?>" height="70px" width="100px" readonly></td>
                      <td><a href="<?php echo base_url('index.php/Control/status_conformation/'.$value->faculty_id);?>" class="btn btn-success btn-sm"><?php echo $value->status;?></a></td>
                      <td><button type="submit" name="submit" class="btn btn-danger btn-sm" onclick="return deletechecked();">delete</button></td>
                    </tr>
                  </tbody>
                </form>  
              <?php
	    ...
	    <div class="footer-top" style="height: 300px;">
	      <div class="container">
	        <div class="row">
	          ...
	          <div class="col-md-12 col-lg-12 footer-info">
	            <h3>Holy Christ</h3>
	            <p>
