  	...
  	<div class="row" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row">
            ...
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/add_subjects/'.$value->admin_id);?>"><i class="fas fa-book fa-5x"></i></a><br><br>
              <h4>ADD SUBJECTS</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/view_registered_courses/'.$value->admin_id);?>"><i class="fas fa-graduation-cap fa-5x"></i></a><br><br>
              <h4>REGISTERED COURSES</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/registered_faculty');?>"><i class="fas fa-users fa-5x"></i></a><br><br>
              <h4>REGISTERED FACULTY</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/admin_logout/'.$value->admin_id);?>"><i class="fas fa-sign-out-alt fa-5x"></i></a><br><br>
              <h4>LOGOUT</h4>
            </div> 
