...
<body>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?php echo base_url('index.php/Control/faculty_register_page');?>">Register</a></li>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row">
  		<div class="col-md-12">
  			<form method="POST" action="<?php echo base_url('index.php/Control/faculty_login');?>">
			  <div class="form-group" data-aos="fade-up" data-aos-delay="100">
			    <label>Email address</label>
			    <input type="email" class="form-control" name="faculty_email" placeholder="Enter email" required>
			  </div>
			  <div class="form-group" data-aos="fade-up" data-aos-delay="200">
			    <label>Password</label>
			    <input type="password" name="faculty_password" class="form-control" pattern=".{6,}" title="Six or more characters" placeholder="Password" required>
			  </div>
