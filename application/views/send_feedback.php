  ...
  <header id="header">
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          <li class="active"><a href="<?php echo base_url('index.php/Control/student_logged_page');?>">Home</a></li>
          <li><a href="#footer">Contact Us</a></li>
          <li style="margin-top: 5px;">
            <form method="POST" action="<?php echo base_url('index.php/Control/send_feedback_search');?>">
              <div class="md-form">
                <input class="form-control-sm" type="text" name="search" placeholder="Search" aria-label="Search">
                <button type="submit" class="btn btn-success btn-sm" style="float: right;"><i class="fa fa-search"></i></button> 
              </div>  
            </form>
          </li>
        </ul>
  	...
  	<div class="table-responsive" data-aos="fade-up" data-aos-delay="200">
          <table class="table table-borderless">
            ...
            <?php
              ...
              {
            ?>
              <form method="POST" action="<?php echo base_url('index.php/Control/feedback/'.$value->course_id);?>">
                <tbody>
                  <tr>
                    <th scope="row"><?php echo $i;?></th>
                    <td><input type="text" name="date" class="border border-light" readonly style="outline: none;" value="<?php echo date('d-m-Y');?>"></td>
                    <td><?php echo $value->faculty_name;?></td>
                    <td><?php echo $value->subject_name;?></td>
                    <td><textarea class="font-italic border border-white" name="feedback" spellcheck="true" lang="en" placeholder="Type feedback here" rows="3" cols="30" style="outline: none;" autofocus required></textarea></td>
                    <td><button type="submit" class="btn btn-danger btn-sm" onclick="return confirmchecked();">send</button></td>
                  </tr>
                </tbody>
              </form>
            <?php
