...
<body>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="form-group" data-aos="fade-up" data-aos-delay="200">
          <form method="POST" action="<?php echo base_url('index.php/Control/register_branch_subject');?>">
            ...
            <div class="mx-auto" id="subject_div" align="center" style="margin-top: 30px;">
              <select class="form-control" name="select_subject" id="subject" required>
          ...
          <script type="text/javascript">
            $(document).ready(function(){
              $("#branch").on('change',function(){
                $.ajax({
                  type:'post',
                  url:"<?php echo base_url('index.php/Control/select_subject');?>",
                  data:{
                    id:$("#branch").val()
                  },
