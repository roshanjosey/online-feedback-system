...
<head>
	...
	<title>student logged page</title>
        ...
        <div class="row">
          ...
          ?>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/my_profile/'.$value->student_id);?>"><i class="fas fa-user-circle fa-5x"></i></a><br><br>
              <h4>MY PROFILE</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/edit_profile/'.$value->student_id);?>"><i class="fas fa-edit fa-5x"></i></a><br><br>
              <h4>EDIT PROFILE</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/send_feedback/'.$value->student_id);?>"><i class="far fa-comment-alt fa-5x"></i></a><br><br>
              <h4>FEEDBACK</h4>
            </div>
            <div class="col-sm-3" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/student_logout/'.$value->student_id);?>"><i class="fas fa-sign-out-alt fa-5x"></i></a><br><br>
              <h4>LOGOUT</h4>
            </div> 
          <?php
            }
