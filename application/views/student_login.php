...
<body>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?php echo base_url('index.php/Control/student_register_page');?>">Register</a></li>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row">
  		<div class="col-md-12">
  			<form method="POST" action="<?php echo base_url('index.php/Control/student_login');?>">
			  ...
			  <div class="form-group" data-aos="fade-up" data-aos-delay="200">
			    ...
			    <input type="password" name="password" class="form-control" pattern=".{6,}" title="Six or more characters" placeholder="Password" required>
			  </div>
