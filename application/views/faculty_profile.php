...
<body>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row">
  		<div class="col-xs-4 col-sm-12 col-md-12" data-aos="fade-up" data-aos-delay="100">

            <form method="POST" enctype="multipart/form-data">
              <div class="form-row container-fluid">
                <div class="form-group col-sm-6 col-md-6">

                    <input type="image" name="image" src="<?php echo base_url('image/'.$value->faculty_image);?>" height="100px" width="150px" readonly style="border: 1px solid black;">                  

                </div>
                <div class="form-group col-sm-6 col-md-6">

                    <label>Name</label>
                    <input type="text" class="form-control" name="name" readonly value="<?php echo $value->faculty_name;?>">
              ...
              <div class="form-group">
                <label>Address</label>
                <input type="text" class="form-control" name="address" readonly value="<?php echo $value->faculty_address;?>">
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label>DOB</label>
                  <input type="date" class="form-control" name="faculty_dob" readonly value="<?php echo $value->faculty_dob;?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Phone Number</label>
                  <input type="text" class="form-control" name="faculty_phone_number" pattern="[789][0-9]{9}" readonly value="<?php echo $value->faculty_phone_number;?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-5">
                  <label for="inputCity">City</label>
                  <input type="text" class="form-control" name="city" readonly value="<?php echo $value->faculty_city;?>">
                </div>
                <div class="form-group col-md-5">
                  <label for="inputCity">State</label>
                  <input type="text" class="form-control" name="state" readonly value="<?php echo $value->faculty_state;?>">
                </div>
                <div class="form-group col-md-2">
                  <label>Zip</label>
                  <input type="number" class="form-control" name="zip" readonly value="<?php echo $value->faculty_zip;?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label>Email</label>
                  <input type="email" class="form-control" name="email" readonly value="<?php echo $value->faculty_email;?>">
                </div>
              </div>
            </form>
