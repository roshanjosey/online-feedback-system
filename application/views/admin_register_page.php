  ...
  <header id="header">
    <div class="container">
      ...
      <div class="logo float-left">
        <h1 class="text-light"><a href="<?php echo base_url('index.php/Control/admin');?>"><span>HOLY CHRIST</span></a></h1>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?php echo base_url('index.php/Control/admin');?>">Login</a></li>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row">
  		<div class="col-xs-12 col-sm-12 col-md-12" data-aos="fade-up" data-aos-delay="100">
  			<form method="POST" enctype="multipart/form-data" action="<?php echo base_url('index.php/Control/admin_register');?>">
          ...
          <div class="form-group">
            ...
            <input type="radio" name="admin_gender" value="male" required>male
            <input type="radio" name="admin_gender" value="female" required style="margin-left: 5px;">female
          </div>
          <div class="form-group">
            <label>Address</label>
            <input type="text" class="form-control" name="admin_address" placeholder="Apartment, studio, or floor" required>
          </div>

            <div class="form-group">
              <label>Phone Number</label>
              <input type="text" class="form-control" name="admin_phone_number" pattern="[789][0-9]{9}" placeholder="Phone Number" required>
            </div>

          <div class="form-row">
            <div class="form-group col-md-5">
              <label for="inputCity">City</label>
              <input type="text" class="form-control" name="admin_city" placeholder="City" required>
            </div>
            <div class="form-group col-md-5">
              <label>State</label>
              <input type="text" class="form-control" name="admin_state" placeholder="State" required>
            </div>
            <div class="form-group col-md-2">
              <label>Zip</label>
              <input type="number" class="form-control" name="admin_zip" placeholder="Zip" required>
            </div>
          </div>
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="password" class="form-control" name="admin_password" pattern=".{6,}" title="Six or more characters" placeholder="Password" required>
            </div>
          </div>
