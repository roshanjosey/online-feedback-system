    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?php echo base_url('index.php/Control/student');?>">Login</a></li>
  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row">
  		<div class="col-xs-12 col-sm-12 col-md-12" data-aos="fade-up" data-aos-delay="100">
  			<form method="POST" enctype="multipart/form-data" action="<?php echo base_url('index.php/Control/student_register');?>">
          ...
          <div class="form-group">
            ...
            <input type="radio" name="gender" value="female" required style="margin-left: 5px;">female
          </div>
          <div class="form-group">
            <label>Address</label>
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="semester" placeholder="Semester" min="1" max="8" required>
          </div>
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="password" class="form-control" name="password" pattern=".{6,}" title="Six or more characters" placeholder="Password" required>
            </div>
          </div>
