  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row">
  		<div class="col-xs-12 col-sm-12 col-md-12" data-aos="fade-up" data-aos-delay="100">
            ...
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('index.php/Control/update_profile/'.$value->student_id);?>">
              <div class="form-row container-fluid">
                <div class="form_group col-sm-6">
                  <div class="row">
                    <input type="image" name="image" src="<?php echo base_url('image/'.$value->image);?>" required height="100px" width="150px" style="border: 1px solid black;">                  
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                ?>>male
                <input type="radio" name="gender" value="female" required style="margin-left: 5px;" <?php
              ...
              <div class="form-group">
                <label>Address</label>
                <input type="text" class="form-control" name="address" required value="<?php echo $value->address;?>">
              </div>
              <div class="form-row">
                <div class="form-group col-md-5">
                  <label for="inputCity">City</label>
                  <input type="text" class="form-control" name="city" required value="<?php echo $value->city;?>">
                </div>
                <div class="form-group col-md-5">
                  <label for="inputCity">State</label>
                  <input type="text" class="form-control" name="state" required value="<?php echo $value->state;?>">
                </div>
                <div class="form-group col-md-2">
                  <label>Zip</label>
                  <input type="number" class="form-control" name="zip" required value="<?php echo $value->zip;?>">
                </div>
              </div>
              <div class="form-group">
                <label>Branch</label>
                <input type="text" class="form-control" name="branch" required value="<?php echo $value->branch;?>">
              </div>
              <div class="form-group">
                <label for="inputAddress2">Semester</label>
                <input type="number" class="form-control" name="semester" required value="<?php echo $value->semester;?>">
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label>Email</label>
                  <input type="email" class="form-control" name="email" required value="<?php echo $value->email;?>">
                </div>
                <div class="form-group col-md-6">
                  <label for="inputPassword4">Password</label>
                  <input type="password" class="form-control" name="password" pattern=".{6,}" title="Six or more characters" placeholder="Password" required value="<?php echo $value->password;?>">
                </div>
              </div>
