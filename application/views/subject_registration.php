  ...
  <div class="container-fluid" style="margin-top: 20px;">
  	<div class="row" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row">
            ...
            <div class="col-sm-6" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/faculty_register_subject');?>"><i class="fas fa-book fa-5x"></i></a><br><br>
              <h4>REGISTER SUBJECTS</h4>
            </div>
            <div class="col-sm-6" align="center" style="height: 200px;margin-top: 50px;">
              <a href="<?php echo base_url('index.php/Control/faculty_view_registered_subjects');?>"><i class="fas fa-save fa-5x"></i></a><br><br>
              <h4>VIEW REGISTERED SUBJECTS</h4>
            </div>          
        </div>
  		</div>
  	</div>
